...
<body>
  ...
  <div class="meta">
    <div class="meta-block">
      ...
      ${receipt.customer_email ? `<p>${receipt.customer_email}</p>` : ''}
      ${receipt.whatsapp ? `<p>📱 ${receipt.whatsapp}</p>` : ''}
    </div>
    <div class="meta-block">
      <label>Vendedor</label>
      <strong>${receipt.seller_name || sellerName || '—'}</strong>
    ...
    <div class="meta-block">
      <label>Estado</label>
      <span class="badge badge-${receipt.status}">${statusLabel}</span>
    </div>
  </div>
  ...
  ${receipt.notes ? `<div class="notes-block"><strong>Observaciones:</strong> ${receipt.notes}</div>` : ''}

  <div class="footer">
    NexaPanel — generado el ${new Date().toLocaleString('es-AR')} · ${receipt.receipt_number}
  </div>
</body>
</html>`
}
