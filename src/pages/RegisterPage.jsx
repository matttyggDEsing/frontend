      ...
      >
        ...
        <div style={{ position: 'relative' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 56 }}>
            <div style={{
              width: 32, height: 32, borderRadius: 8, background: 'linear-gradient(135deg,#10B981,#059669)',
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
      ...
      <div style={{
        ...
        <div style={{ paddingLeft: 11, display: 'flex', alignItems: 'center', color: focused ? 'var(--em3)' : 'var(--txt3)', transition: 'color .2s', flexShrink: 0 }}>
          <Icon size={14} />
        </div>
        <input
