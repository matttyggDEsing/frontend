...
const STYLES = {
  // CSS-class-backed (matches globals.css)
  pending:    { background: 'rgba(245,158,11,0.12)',  color: '#FCD34D' },
  active:     { background: 'rgba(16,185,129,0.12)',  color: '#34D399' },
  completed:  { background: 'rgba(99,102,241,0.12)',  color: '#A5B4FC' },
  cancelled:  { background: 'rgba(239,68,68,0.12)',   color: '#FCA5A5' },
  processing: { background: 'rgba(59,130,246,0.12)',  color: '#93C5FD' },
  // Extras
  ...
  info:       { background: 'rgba(59,130,246,0.12)',  color: '#93C5FD' },
  purple:     { background: 'rgba(139,92,246,0.12)',  color: '#C4B5FD' },
  hot:        { background: 'rgba(16,185,129,0.15)',  color: '#34D399' },
